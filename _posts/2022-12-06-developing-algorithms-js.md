...
badges: true
comments: true
nb_path: _notebooks/2022-12-06-developing-algorithms-js.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-12-06-developing-algorithms-js.ipynb
-->
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-javascript"><pre><span></span><span class="c1">//  split string using javascript numbs = ip.split(&quot;.&quot;) then  use decTobinary for each of the split string).</span>
<span class="c1">//  Might need to convert string to int. Check decTobinary</span>
</pre></div>
